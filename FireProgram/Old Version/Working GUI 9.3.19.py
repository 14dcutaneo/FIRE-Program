...
workAreaSelection.grid(row = 0, column = 5)
...
areaStaionLineLabel.grid(row = 3, column = 5)
...
placeRemoveLabel.grid(row = 8, column = 5)
...
workAreaDropDown.grid(row=1, column=5)  # Places the drop down
...
workStationDropDown.grid(row=2, column=5)  # Places the drop down
...
def placeArea(event):
    ...
    if(str(workAreaMenu.get()) == "Recieving"):#Does not actually get placed
        ...
        if((int(pointerx - factor1(sizeBox1x))<0) or (int(pointery - factor2(sizeBox1y)) < 0) or (int(pointerx + factor1(sizeBox1x)) >700) or (int(pointery + factor2(sizeBox1y)) > 700)):
            errorWindow()
        elif((int(sizeBox1x.get())*int(sizeBox1y.get())) < 8000 or (int(sizeBox1x.get())*int(sizeBox1y.get())) > 16900):
            error1Window()
        else:
        ...
        if((int(pointerx - factor1(sizeBox2x))<0) or (int(pointery - factor2(sizeBox2y)) < 0) or (int(pointerx + factor1(sizeBox2x)) >700) or (int(pointery + factor2(sizeBox2y)) > 700)):
            errorWindow()
        elif((int(sizeBox2x.get())*int(sizeBox2y.get())) < 6000 or (int(sizeBox2x.get())*int(sizeBox2y.get())) > 16900):
            error1Window()
        else:
        ...
        if((int(pointerx - factor1(sizeBox3x))<0) or (int(pointery - factor2(sizeBox3y)) < 0) or (int(pointerx + factor1(sizeBox3x)) >700) or (int(pointery + factor2(sizeBox3y)) > 700)):
            errorWindow()
        elif((int(sizeBox3x.get())*int(sizeBox3y.get())) < 7000 or (int(sizeBox3x.get())*int(sizeBox3y.get())) > 16900):
            error1Window()
        else:
        ...
        if((int(pointerx - factor1(sizeBox4x))<0) or (int(pointery - factor2(sizeBox4y)) < 0) or (int(pointerx + factor1(sizeBox4x)) >700) or (int(pointery + factor2(sizeBox4y)) > 700)):
            errorWindow()
        elif((int(sizeBox4x.get())*int(sizeBox4y.get())) < 5000 or (int(sizeBox4x.get())*int(sizeBox4y.get())) > 16900):
            error1Window()
        else:
        ...
        if((int(pointerx - factor1(sizeBox5x))<0) or (int(pointery - factor2(sizeBox5y)) < 0) or (int(pointerx + factor1(sizeBox5x)) >700) or (int(pointery + factor2(sizeBox5y)) > 700)):
            errorWindow()
        elif((int(sizeBox5x.get())*int(sizeBox5y.get())) < 5000 or (int(sizeBox5x.get())*int(sizeBox5y.get())) > 16900):
            error1Window()
        else:
        ...
        if((int(pointerx - factor1(sizeBox6x))<0) or (int(pointery - factor2(sizeBox6y)) < 0) or (int(pointerx + factor1(sizeBox6x)) >700) or (int(pointery + factor2(sizeBox6y)) > 700)):
            errorWindow()
        elif((int(sizeBox6x.get())*int(sizeBox6y.get())) < 5000 or (int(sizeBox6x.get())*int(sizeBox6y.get())) > 16900):
            error1Window()
        else:
